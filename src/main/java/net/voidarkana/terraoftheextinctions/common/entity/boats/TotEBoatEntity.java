...
public class TotEBoatEntity extends Boat {
    private static final EntityDataAccessor<Integer> DATA_ID_TYPE = SynchedEntityData.defineId(Boat.class, EntityDataSerializers.INT);

    public TotEBoatEntity(EntityType<? extends Boat> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
    }

    public TotEBoatEntity(Level level, double pX, double pY, double pZ) {
        this(TotEEntities.MOD_BOAT.get(), level);
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_ID_TYPE, Type.OLIVE.ordinal());
    }
    ...
    public static enum Type implements StringRepresentable {
        ...
        public static Type byName(String pName) {
            return CODEC.byName(pName, OLIVE);
        }
    }
}
