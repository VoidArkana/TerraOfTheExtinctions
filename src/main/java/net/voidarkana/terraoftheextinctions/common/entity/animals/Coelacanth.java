...
import net.voidarkana.terraoftheextinctions.common.entity.animals.ai.*;
...
public class Coelacanth extends BreedableWaterAnimal implements IAnimatedAttacker {
    ...
    public static final Ingredient FOOD_ITEMS = Ingredient.of(TotETags.Items.COELACANTH_FOOD);
    private static final EntityDataAccessor<Boolean> IS_ATTACKING = SynchedEntityData.defineId(Coelacanth.class, EntityDataSerializers.BOOLEAN);

    @Override
    public boolean isFood(ItemStack pStack) {
        return pStack.is(TotETags.Items.COELACANTH_FOOD);
    }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new FishBreedGoal(this, 1.15D));

        this.goalSelector.addGoal(3, new AnimatedAttackGoal(this,  1.25F, true, 7, 5));
        ...
        this.targetSelector.addGoal(4, new NearestAttackableTargetGoal<>(this, LivingEntity.class, 10, true, false, (entity) -> {
            return entity instanceof Bleak || entity instanceof Cod;
        }));
    }
    ...
    public @Nullable BreedableWaterAnimal getBreedOffspring(ServerLevel pLevel, BreedableWaterAnimal pOtherParent) {
        return TotEEntities.COELACANTH.get().create(pLevel);
    }
